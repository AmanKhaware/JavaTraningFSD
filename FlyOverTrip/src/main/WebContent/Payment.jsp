...
<body>
    ...
    <sql:update dataSource="${db}" var="res_insert">  
		INSERT INTO registrationdetail VALUES ( "${param.fullname}", "${param.address}", ${param.age}, "${param.mobileno}", "${param.emailid}", "${param.id}", "${param.country}"   );  
	</sql:update>
	...
	<div class="container">
      ...
      <div class="card-details">
        ...
        <a href="confirmation.jsp?emailid=<%= emailid %>&flight_no=<%= flight_no %>&transaction=sucessful">
        <button type="submit" 
